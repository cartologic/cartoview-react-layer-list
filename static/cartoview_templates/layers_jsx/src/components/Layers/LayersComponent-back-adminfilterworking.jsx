...
export default class LayersComponent extends React.Component{
  ...
  getData () {
    ...
    fetch(this.state.apiURL, { credentials: 'include'})
      ...
      .then((res)=>{res.json()
        ...
        }, ()=>{console.log(this.state.apiURL.href,this.state.layers_JSON);});
      })})
    }
  ...
  onFilterItemClick(e, apiKey, filterValue, urlSearchParam, filterValues, valuesActivated, index){
    // delete all previous searchParams first
    let params = {};
    params[urlSearchParam] = ""; // appen{urlSearchParm: ''} to params
    let url = new URL(this.getUrlWithQS(this.state.apiURL, params, "delete"));
    ...
    if(e.target.className === "list-group-item active"){
      ...
      // params["keywords__slug__in"] = values_str;
      params[urlSearchParam] = values_str;
        ...
        <Row>
          <Col md="3" >
            ...
            <ListFilter
              ...
              urlSearchParam = {"keywords__slug__in"}
              apiKey = {"name"}
              filterValues = {"keywords"}
              valuesActivated = {"keywordsActivated"}
              onFilterItemClick = {(e, apiKey, filterValue, urlSearchParam, filterValues, valuesActivated, index)=>{this.onFilterItemClick(e, apiKey, filterValue, urlSearchParam, filterValues, valuesActivated, index)}}
              />
            <hr/>
            ...
            <ListFilter
              ...
              urlSearchParam = {"owner__username"}
              apiKey = {"username"}
              filterValues = {"owners"}
            ...
            <ListFilter
              ...
              urlSearchParam = {"category__identifier__in"}
              apiKey = {"identifier"}
